        ...
        <div class="post_body">
            <form action="{{ route('blog_store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" style="width:750px;height:300px;">{{ old('content') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="tags">标签</label>
                    <input type="text" id="tags" name="tags" placeholder="多个的话以空格分割" value="{{ old('tags') }}">
